...
export function findAllBorrowRequests(http: HttpClient, rootUrl: string, params?: FindAllBorrowRequests$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseBorrowedBookResponse>> {
...
findAllBorrowRequests.PATH = '/books/borrow-requests';
